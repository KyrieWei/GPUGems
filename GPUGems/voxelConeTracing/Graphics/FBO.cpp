...
FBO::FBO(GLuint w, GLuint h, GLenum magFilter, GLenum minFilter, GLint internalFormat, GLint format, GLint wrap) : width(w), height(h)
{
...
void FBO::ActivateAsTexture(Shader& shader, const std::string glSamplerName, const int textureUnit)
{
	shader.use();
